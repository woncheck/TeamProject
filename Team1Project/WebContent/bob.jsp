...
<%
	...
	if (name_place == null) {
		...
		no = 1;
		list = dao.search_bob(name_place);
	}
%>
...
/* body_top css */
.body_top .menu2 a.cafe:hover {
	background-color: #ff4848;
}

.body_top .menu2 a.bob{
	background-color: #f5c041;
}
...
<body>
	<center>
		...
		<div class="body_top">
			<div class="menu">
				...
				<div class="menu3"
					...
					<a href="heart.jsp?name=name"><img src="images/main/heart.jpg"></a>
				</div>
		...
		<h2 class="title">맛있는 밥집, 가성비 극강</h2>
		...
		<fieldset class="main-search ng-scope"
			...
			<label class="search-word" for="main-search">
				<form action="bob.jsp" method="post">
		...
		</header> </article><hr style="border: 1px solid #f5c041;" width="100%"> </main>
						...
						<tr>
							...
							<td width="150px"><div class="top_image">
									...
									<a href="detailform.jsp?no=<%=no3%>&name=<%=type%>"> <img class="_iv4d5"
										src='images/main/kate/bob/<%=list2.get(i).getNo()%>.jpg'>
									</a>
								</div></td>
					
					<td width="550px" style="font-size: 18px; font-style: bold;"><h2 title="bob">#hot #popular #인기있는
				...
				<div id=list>
					...
					<form action="detailform.jsp" method="post">
						...
						<a href="detailform.jsp?no=<%=no2%>&name=<%=type%>">
							<p class="img"
								STYLE="background-image: URL('images/main/kate/bob/<%=vo.getNo()%>.jpg') "></p>
