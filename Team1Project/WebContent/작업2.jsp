...
<body>
	<div id="main">
		<div id="main_wrap">
			...
			<div id="main_cont">
				<ul>
					<li class="카페"><a href="cafe.jsp"><img src="images/cafe.jpg" width="100%" alt="카페" /><span class="place">카페</span><span class="address">당신이 있는 그 곳에  <em> / </em>커피 한 잔의 여유를</span><span class="tel">TEL : 0211-3422-7732</span></a></li>
					<li class="밥집"><a href="bob.jsp"><img src="images/bob.jpg" width="100%" alt="밥집" /><span class="place">밥집</span><span class="address">당신이 있는 그 곳에  &nbsp;</em><em> / </em> 1인분 같은 2인분을</span><span class="tel">TEL : 0211-9637-2755</span></a></li>
					<li class="술집" style="text-align:left;"><a href="sul.jsp"><img src="images/sul.jpg" width="100%" alt="술집" /><span class="place">술집</span><span class="address">당신이 있는 그 곳에  <em> / </em>오늘을 담을 술잔을</span><span class="tel">TEL : 0211-1251-1769</span></a></li>
				</ul>
			</div>
		</div>
